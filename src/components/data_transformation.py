...
class DataTransformation:
    ...
    def initiate_data_transformation(self, train_path, test_path):
        ...
        try:
            ...
            '''
            input_feature_train_df = train_df[['gender', 'race_ethnicity', 'parental_level_of_education', 'lunch',
            ...
            save_object(
                file_path = self.data_trransformation_config.preprocessor_obj_file_path,
                obj=preprocessing_obj
            )
            return(
                train_arr,
                test_arr,
                self.data_trransformation_config.preprocessor_obj_file_path,
            )
